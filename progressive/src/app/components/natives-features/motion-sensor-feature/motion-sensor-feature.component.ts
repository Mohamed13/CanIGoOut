...
@Component({
  selector: 'app-motion-sensor-feature',
  templateUrl: './motion-sensor-feature.component.html',
  styleUrls: ['./motion-sensor-feature.component.scss']
})
export class MotionSensorFeatureComponent implements OnInit, AfterViewInit {
